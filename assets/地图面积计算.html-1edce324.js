import{_ as s,o as a,c as e,a as t,d as c}from"./app-e6599bc7.js";const i={},p=c(`<h1 id="地图面积计算" tabindex="-1"><a class="header-anchor" href="#地图面积计算" aria-hidden="true">#</a> 地图面积计算</h1><p>基于高德地图，根据用户选点（鼠标移动）创建标注点，满足至少三个标注点时可以形成多边形并计算其面积，采用命令模式实现撤销功能。</p><h2 id="功能" tabindex="-1"><a class="header-anchor" href="#功能" aria-hidden="true">#</a> 功能</h2><ul><li>创建标注点</li><li>创建标注点之间的连线</li><li>计算面积</li><li>撤销及清除重绘</li></ul><h2 id="绘制多边形实体类代码" tabindex="-1"><a class="header-anchor" href="#绘制多边形实体类代码" aria-hidden="true">#</a> 绘制多边形实体类代码</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 画多边形区域类</span>
