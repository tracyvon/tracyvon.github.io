import{_ as n,o as s,c as a,d as t}from"./app-cce8de6a.js";const p="/assets/ERR_BLOCKED_BY_CLIENT_1-c54d325d.png",e="/assets/ERR_BLOCKED_BY_CLIENT_2-3c2745b5.png",o={},c=t('<h1 id="h5-端-引用-uni-popup-组件异常" tabindex="-1"><a class="header-anchor" href="#h5-端-引用-uni-popup-组件异常" aria-hidden="true">#</a> H5 端 引用 <code>uni-popup</code> 组件异常</h1><h2 id="问题复现" tabindex="-1"><a class="header-anchor" href="#问题复现" aria-hidden="true">#</a> 问题复现</h2><p>页面代码引用了一个第三方的 <code>sku</code> 组件及 <code>uni-popup</code> 组件，在微信小程序端正常使用，无异常报错，而切换为 H5 端（Chrome 浏览器）运行时报错误了。</p><figure><img src="'+p+`" alt="异常信息截图" tabindex="0" loading="lazy"><figcaption>异常信息截图</figcaption></figure><div class="language-Vue line-numbers-mode" data-ext="Vue"><pre class="language-Vue"><code>&lt;!-- 商品详情页面主要代码 --&gt;
&lt;template&gt;
