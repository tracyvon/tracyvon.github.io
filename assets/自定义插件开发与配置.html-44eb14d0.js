import{_ as u,r as p,o as r,c as d,a as n,b as s,e as o,w as a,d as c}from"./app-311ce39c.js";const k={},v=n("h1",{id:"自定义插件开发与配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#自定义插件开发与配置","aria-hidden":"true"},"#"),s(" 自定义插件开发与配置")],-1),m=n("h2",{id:"通过-hooks-方式实现浏览器标签页的动态标题切换组件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#通过-hooks-方式实现浏览器标签页的动态标题切换组件","aria-hidden":"true"},"#"),s(" 通过 Hooks 方式实现浏览器标签页的动态标题切换组件")],-1),b=n("li",null,[s("在 "),n("code",null,"src"),s(" 目录下创建 "),n("code",null,"plugins/dynamic-title"),s(" 目录")],-1),g=n("code",null,"dynamic-title",-1),f=n("code",null,"dynamicTitlePlugin.js",-1),y={href:"https://github.com/moefyit/vuepress-plugin-dynamic-title",target:"_blank",rel:"noopener noreferrer"},h=c(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> onMounted<span class="token punctuation">,</span> watch <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;vue&quot;</span><span class="token punctuation">;</span>
...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),T=c(`<ul><li>在 <code>plugins</code> 目录下创建 <code>plugins/canvas-nest</code> 目录</li><li>在 <code>canvas-nest</code> 目录新建 <code>canvasNestPlugin.js</code>，键入如下代码</li></ul><div class="language-Vue line-numbers-mode" data-ext="Vue"><pre class="language-Vue"><code>...
...
<span class="token keyword">export</span> <span class="token keyword">default</span> plugin<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function x(E,I){const i=p("ExternalLinkIcon"),l=p("Tabs");return r(),d("div",null,[v,m,n("ul",null,[b,n("li",null,[s("在 "),g,s(" 目录下新建 "),f,s("，键入如下代码，基于 "),n("a",y,[s("vuepress-plugin-dynamic-title"),o(i)]),s(" 调整")])]),h,o(l,{id:"52",data:[{id:"npm"},{id:"yarn"},{id:"pnpm"}],"tab-id":"install"},{title0:a(({value:t,isActive:e})=>[s("npm")]),title1:a(({value:t,isActive:e})=>[s("yarn")]),title2:a(({value:t,isActive:e})=>[s("pnpm")]),tab0:a(({value:t,isActive:e})=>[w]),tab1:a(({value:t,isActive:e})=>[q]),tab2:a(({value:t,isActive:e})=>[_]),_:1}),T])}const j=u(k,[["render",x],["__file","自定义插件开发与配置.html.vue"]]);export{j as default};
